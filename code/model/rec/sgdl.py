...
class LightGCN(MetaModule):
    ...
    def __init_weight(self):
        ...
        self.latent_dim = self.config["rec_model_p"]["latent_dim_rec"]
        self.n_layers = self.config["rec_model_p"]["lightGCN_n_layers"]
        self.keep_prob = self.config["rec_model_p"]["keep_prob"]
        self.A_split = self.config["rec_model_p"]["A_split"]
